...
.workspace { display: grid; min-height: 0; flex: 1; grid-template-columns: clamp(190px, 15vw, 250px) clamp(310px, 25vw, 390px) minmax(420px, 1fr); gap: 14px; width: 100%; }
